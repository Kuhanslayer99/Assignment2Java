...
public class Assignment2game {
	...
	Font normalFont = new Font("Monospaced", Font.BOLD, 22);
	...
	public Assignment2game(){
		...
		titleNameLabel = new JLabel("QUESTS 2KILL");
		titleNameLabel.setForeground(Color.red);
		titleNameLabel.setFont(titleFont);	
		
		startButtonPanel = new JPanel();
		startButtonPanel.setBounds(260, 400, 250, 100);
	...
	public void townGate(){
		position = "townGate";
		mainTextArea.setText("You are at the gate of the town. \nA guard is standing in front of you.\nA a bird is following you on your shoulder. \n\nWhat do you do?");		
		choice1.setText("Talk to the guard");
		choice2.setText("Attack the guard");
		choice3.setText("Talk to the bird");
	...
	public void attackGuard(){
        ...
        public void talkBird(){
                position = "talkBird";
                mainTextArea.setText("I am a bird who helps you save your progress.\n\n(Your progress is saved)");
                choice1.setText(">");
		choice2.setText("");
		choice3.setText("");
		choice4.setText("");
	...
	public void crossRoad(){
		...
		choice1.setText("Quest 1");
		choice2.setText("Quest 2");
		choice3.setText("Quest 3");
		choice4.setText("Quest 4");
	}
	public void north(){
		position = "north";
